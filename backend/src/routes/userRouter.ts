...
import { verifyRefreshToken,verifyAccessToken,verifyRole } from "../middlewares/authMiddleware";
...
router.post("/register", validateStudentRegister, studentController.createStudent);
